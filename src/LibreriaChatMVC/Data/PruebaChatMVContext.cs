...
namespace LibreriaChatMVC.Data
{
    public class PruebaChatMVContext : DbContext
    {
        ...
        private readonly ISeeder<Estatus, Usuario[]> _estatusSeeder;
        private readonly ISeeder<Usuario> _usuarioSeeder;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var usuarios = _usuarioSeeder.ApplySeed();
            var estatus = _estatusSeeder.ApplySeed(usuarios);
            ...
            modelBuilder.Entity<Estatus>(e =>
            {
                ...
                e.HasData(estatus);
                e.Navigation(e => e.Rel_Estatus_Estado)
                .AutoInclude(true);
            });
            modelBuilder.Entity<Usuario>(e =>
            {
                ...
                .HasForeignKey<Estatus>(es => es.IdUsuario)
                .OnDelete(DeleteBehavior.Cascade);
                AplicarSoftDelete(e);
                e.HasData(usuarios);
                e.Navigation(u => u.Rel_Usuario_Rol)
                .AutoInclude(true);
                e.Navigation(u => u.Rel_Usuario_Estatus)
                .AutoInclude(true);
            });
